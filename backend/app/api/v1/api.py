...
from app.api.v1 import auth, resumes, jobs, analysis, roadmap
...
api_router.include_router(roadmap.router, prefix="/roadmap", tags=["Learning Roadmap & Recommendations"])
